-- 0008 — Nome del segnalatore + submit_report con parametro p_name.
-- Il flusso di invio ora raccoglie: foto, posizione, descrizione, categoria e nome.
